<?php
    ...
    function postCurlData($api_url,$post_args){
        $curl = curl_init(); // Init the cURL
        curl_setopt($curl, CURLOPT_URL,$api_url); // Set the POST url
        curl_setopt($curl, CURLOPT_POST, true); // Enable POST
        curl_setopt($curl, CURLOPT_POSTFIELDS,$post_args); // OH BABY A PENTA+!
